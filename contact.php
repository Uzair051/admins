...
<!-- Mirrored from polygons.space/neptune/source/templates/admin1/index.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Feb 2023 16:46:24 GMT -->
<head>
    <meta charset="utf-8">
        ...
        <div class="app-sidebar">
            ...
            <div class="app-menu">
                <ul class="accordion-menu">
                    ...
                    <li>
                        <a href="orders.php"><i class="material-icons-two-tone">inbox</i>Orders<span class="badge rounded-pill badge-danger float-end">87</span></a>
                    </li>
                    <li>
                        <a href="users.php  "><i class="material-icons-two-tone">cloud_queue</i>Users</a>
                    </li>
                    <li>
                        <a href="contact.php"><i class="material-icons-two-tone">edit</i>Contact<span class="badge rounded-pill badge-success float-end">14</span></a>
                    </li>
                    <li>
                        <a href="todo.html"><i class="material-icons-two-tone">done</i>Logout</a>
                    </li>
